...
$totalPesanKritik = mysqli_query($db, "SELECT COUNT(id) FROM pesan WHERE kategori='Kritik/Saran'");
$totalPesanBiasa = mysqli_query($db, "SELECT COUNT(id) FROM pesan WHERE kategori='Pesan Biasa'");
$pesanKritik = mysqli_query($db, "SELECT * FROM pesan WHERE kategori='Kritik/Saran'");
$pesanBiasa = mysqli_query($db, "SELECT * FROM pesan WHERE kategori='Pesan Biasa'");

$totalPesanKritik = mysqli_fetch_assoc($totalPesanKritik);
$totalPesanBiasa = mysqli_fetch_assoc($totalPesanBiasa);
...
<body class="flex bg-gray-100">
    ...
    <div class="container w-[80%] ml-[17em] mx-auto p-2">
        <div class="w-full p-2 flex justify-between">
            <div class="flex gap-[10px]">
                <div class="bg-[#A3E4DB] flex flex-col w-[200px] rounded-tr-xl rounded-bl-xl p-2">
                    <h1 class="text-xl text-center">Total Data Pesan Anonym</h1>
                    <div class="flex justify-center items-center mt-2">
                        ...
                        <h1 class="ml-3 text-xl"><?php echo $totalPesanBiasa['COUNT(id)'] ?></h1>
                    </div>
                </div>
                <div class="bg-[#A3E4DB] flex flex-col w-[200px] rounded-tr-xl rounded-bl-xl p-2">
                    <h1 class="text-xl text-center">Total Data Pesan Kritik dan Saran</h1>
                    <div class="flex justify-center items-center mt-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-8">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <h1 class="ml-3 text-xl"><?php echo $totalPesanKritik['COUNT(id)'] ?></h1>
                    </div>
                </div>
            </div>
        ...
        <h1 class="font-bold text-3xl text-center mt-3 mb-3">Data Menfess</h1>
                ...
                <thead class="bg-[#A3E4DB]">
                    <tr>
                        ...
                        <th
                            ...
                            Pesan</th>
                        <th
                            class="w-[5%] px-6 py-3 border-b-2 border-gray-200 text-left leading-4 text-gray-600 tracking-wider">
                            Action</th>
                    </tr>
                </thead>
        ...
        <h1 class="font-bold text-xl mt-3 mb-3">Data Pesan Kritik</h1>
