...
<head>
    ...
    <title>Data Songfess Himtalks per tanggal <?php echo $date ?></title>
...
<body class="flex bg-gray-100">
    <div class="container w-[80%] mx-auto p-2">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-200" id="table_songfess">
